...
struct Stg_HeikinAshi_EURUSD_M1_Params : Stg_HeikinAshi_Params {
  Stg_HeikinAshi_EURUSD_M1_Params() {
    symbol = "EURUSD";
    tf = PERIOD_M1;
    HeikinAshi_Period = 32;
